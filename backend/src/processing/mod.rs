...
pub fn load_processors(router: &mut Router) {
    ...
    router.add_rule("/usergroup/member/remove", user_group::remove_member_processor);
    ...
    router.add_rule("/agile/project/lookup/backlog", agile::project::lookup_backlog_processor);
    ...
    router.add_rule("/agile/story/lookup/backlog", agile::story::lookup_backlog_processor);
